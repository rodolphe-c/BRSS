...
namespace brss
{
	...
	inline
	std::string version() { return std::to_string(version_major())+"."+std::to_string(version_minor())+"."+std::to_string(version_patch()); }

	inline 
	std::string codename() { return "Let's start simulation !"; }
}
