...
namespace hopp
{
	...
	namespace random
	{
		...
		/// @ingroup hopp_random
		inline hopp::random::uniform_t<bool> make_true_false_t(double const probability, hopp::ulint seed = hopp::now::nanoseconds<hopp::ulint>())
		{
		...
		/// @return the hopp::random::uniform_t<bool> wanted
		/// @ingroup hopp_random
		inline hopp::random::uniform_t<bool> make_true_false_t(hopp::ulint seed = hopp::now::nanoseconds<hopp::ulint>())
		{
